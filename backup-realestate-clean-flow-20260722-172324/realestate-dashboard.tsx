...
const [activeTab, setActiveTab] = useState("overview");
  ...
  window.dispatchEvent(
    new Event("realestate-properties-updated")
  );
}, [properties, isClient]);
          ...
          : filtered.map(p =>
            React.createElement("div", { key: p.id, style: styles.card },
              ...
              React.createElement("div", { style: { marginTop: "12px", display: "flex", gap: "8px", flexWrap: "wrap" } },
                React.createElement("button", { onClick: () => window.open(`https://wa.me/${p.contactNumber || "9876543210"}?text=Hi, I'm interested in ${p.title}`, "_blank"), style: styles.buttonSuccess }, "ðŸ“± Enquire")
              )
            )
          )
      )
  ...
  const renderAffiliate = () => {
    ...
    return React.createElement("div", null,
      React.createElement("div", { style: styles.card },
        React.createElement("h2", { style: { color: "#1a5f7a", marginTop: 0 } }, "ðŸ˜ï¸ BuildMitra Marketing Partner - Layout Upload"),
      ...
      React.createElement("div", { style: styles.card },
        React.createElement("h2", { style: { color: "#1a5f7a", marginTop: 0 } }, "ðŸ“ Plot Inventory - Available / Sold / Booked"),
      ...
      React.createElement("div", { style: styles.card },
        React.createElement("h2", null, "ðŸ“‹ Uploaded Layouts"),
        layouts.length === 0 ? React.createElement("p", null, "No layouts uploaded yet.") :
          layouts.map(l => React.createElement("div", { key: l.id, style: { padding: 10, borderBottom: "1px solid #eee" } },
            React.createElement("b", null, l.layoutName), " - ", l.location, " - â‚¹", l.ratePerSft, "/sft"
          ))
      ),

      React.createElement("div", { style: styles.card },
        React.createElement("h2", null, "ðŸ“ Plot List"),
        plots.length === 0 ? React.createElement("p", null, "No plots added yet.") :
          plots.map(p => React.createElement("div", { key: p.id, style: { padding: 10, borderBottom: "1px solid #eee" } },
            React.createElement("b", null, "Plot ", p.plotNo), " - ", p.layoutName, " - ", p.status, " - â‚¹", p.ratePerSft, "/sft"
          ))
      )
    );
  };
