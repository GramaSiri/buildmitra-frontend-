...
const MOCK_PROJECTS: RealEstateProject[] = [
  {
    id: "proj-101",
    builderName: "BuildMitra Demo Projects",
    builderGstin: "29AAAAA0000A1Z5",
    projectCode: "BM-MEADOWS-01",
    projectName: "Buildmitra Meadows",
    ...
    description: "Residential Layout featuring RERA-approved plotted layout & 2/3 BHK luxury residences with clubhouse & Vastu compliant designs.",
    status: "Active",
  ...
  },
  {
    ...
    projectCode: "BM-ROYAL-02",
    projectName: "Buildmitra Royal Crest",
    ...
    description: "Premium Residential Layout with high rise apartments & commercial retail spaces crafted with modern structural technology.",
    status: "Active",
  ...
  },
  {
    id: "proj-103",
    builderName: "BuildMitra Demo Projects",
    builderGstin: "29CCCCC2222C3Z9",
    projectCode: "BM-GREENLAYOUTS-03",
    projectName: "Buildmitra Green Layouts",
    location: "Sarjapur Road, East Bengaluru",
    city: "Bengaluru",
    pincode: "562125",
    reraNumber: "PRM/KA/RERA/1251/311/PR/230615/006190",
    totalUnits: 40,
    totalAreaSqFt: 110000,
    commissionType: "percentage",
    defaultCommissionValue: 4.0,
    description: "Eco-friendly residential layout featuring villa plots, 40ft asphalt roads, underground drainage & avenue plantation.",
    status: "Active",
    ...
    inventory: [
      {
        ...
        totalUnitCost: 7200000,
        negotiatedCommissionType: "percentage",
        negotiatedCommissionValue: 4.0,
        negotiatedMarginDiff: 30000,
        calculatedCommission: 318000,
        facing: "East",
        status: "Available",
      },
    ],
  ...
  },
  {
    id: "proj-104",
    builderName: "BuildMitra Demo Projects",
    builderGstin: "29DDDDD3333D4Z1",
    projectCode: "BM-SMART-04",
    projectName: "Buildmitra Smart Apartments",
    location: "Electronic City Phase 1, Bengaluru",
    city: "Bengaluru",
    pincode: "560100",
    reraNumber: "PRM/KA/RERA/1251/313/PR/230920/006880",
    totalUnits: 60,
    totalAreaSqFt: 75000,
    commissionType: "percentage",
    defaultCommissionValue: 3.5,
    description: "Modern small size apartments (1BHK & 2BHK compact units 550 - 850 Sq.Ft) crafted for urban professionals with gym & rooftop garden.",
    status: "Active",
    heroImage: "https://images.unsplash.com/photo-1545324418-cc1a3fa10c00?auto=format&fit=crop&w=800&q=80",
    offers: [],
    mediaDrawings: [],
    inventory: [
      {
        id: "unit-401",
        unitNo: "Flat 204 (1BHK)",
        type: "1BHK",
        areaSqFt: 580,
        baseRatePerSqFt: 5500,
        totalUnitCost: 3190000,
        negotiatedCommissionType: "percentage",
        negotiatedCommissionValue: 3.5,
        negotiatedMarginDiff: 15000,
        calculatedCommission: 126650,
        facing: "East",
        status: "Available",
        floor: "2nd Floor",
        notes: "Compact 1BHK small size apartment, fully fitted kitchen.",
      },
      {
        id: "unit-402",
        unitNo: "Flat 308 (2BHK)",
        type: "2BHK",
        areaSqFt: 820,
        baseRatePerSqFt: 5400,
        totalUnitCost: 4428000,
        negotiatedCommissionType: "percentage",
        negotiatedCommissionValue: 3.5,
        negotiatedMarginDiff: 20000,
        calculatedCommission: 174980,
        facing: "North-East",
        status: "Available",
        floor: "3rd Floor",
        notes: "Smart 2BHK small size residence with balcony.",
      },
    ],
  ...
  },
  {
    id: "proj-105",
    builderName: "BuildMitra Demo Projects",
    builderGstin: "29EEEEE4444E5Z2",
    projectCode: "BM-NEMADHI-05",
    projectName: "Buildmitra Nemadhi",
    location: "Yelahanka New Town, North Bengaluru",
    city: "Bengaluru",
    pincode: "560064",
    reraNumber: "PRM/KA/RERA/1251/309/PR/230112/005612",
    totalUnits: 24,
    totalAreaSqFt: 60000,
    commissionType: "percentage",
    defaultCommissionValue: 3.5,
    description: "Serene Residential Layout surrounded by lush greenery, asphalt wide roads, and underground utility connections.",
    status: "Active",
    heroImage: "https://images.unsplash.com/photo-1592595896551-12b371d546d5?auto=format&fit=crop&w=800&q=80",
    offers: [],
    mediaDrawings: [],
    inventory: [
      {
