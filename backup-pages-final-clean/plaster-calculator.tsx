  ...
  return (
    <div style={{ padding: 20, background: "linear-gradient(135deg,#fdf2f8,#fff7ed,#eef2ff)", minHeight: "100vh", fontFamily: "Arial" }}>
      ...
      <div style={{ display: "flex", gap: 10, marginBottom: 16 }}>
        ...
        <button onClick={() => checkAndRun('calculator_export', 'plaster-calculator', exportExcel)} style={{ background: "#0d6efd", color: "white", border: 0, borderRadius: 10, padding: "12px 18px", cursor: "pointer" }}>📊 Excel</button>
        <button onClick={() => checkAndRun('calculator_export', 'plaster-calculator', shareWhatsApp)} style={{ background: "#25D366", color: "white", border: 0, borderRadius: 10, padding: "12px 18px", cursor: "pointer" }}>💬 Share</button>
      </div>
