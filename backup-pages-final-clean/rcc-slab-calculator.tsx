...
Total: ₹${fmt(result.costs.grandTotal)}`);
  ...
  return React.createElement("div", { style: styles.container },
    ...
    React.createElement("div", { style: styles.buttonRow },
      ...
      React.createElement("button", { onClick: () => checkAndRun('calculator_export', 'rcc-slab-calculator', exportExcel), style: styles.buttonExport }, "📊 Excel"),
      React.createElement("button", { onClick: () => checkAndRun('calculator_export', 'rcc-slab-calculator', shareWhatsApp), style: styles.buttonWhatsapp }, "💬 Share")
    ),
