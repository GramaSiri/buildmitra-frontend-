...
export default function StaircasePage() {
  ...
  return React.createElement('div', { style: styles.container },
    ...
    React.createElement('div', { style: styles.row6 },
      React.createElement('div', null, React.createElement('label', { style: styles.label }, 'Riser (in)'), React.createElement('input', { type: 'number', value: rise, onChange: (e) => setRise(parseFloat(e.target.value)), style: styles.input })),
      React.createElement('div', null, React.createElement('label', { style: styles.label }, 'Tread (in)'), React.createElement('input', { type: 'number', value: tread, onChange: (e) => setTread(parseFloat(e.target.value)), style: styles.input })),
      ...
      React.createElement('div', null, React.createElement('label', { style: styles.label }, 'No. of Steps'), React.createElement('input', { type: 'number', value: numSteps, onChange: (e) => setNumSteps(parseFloat(e.target.value)), style: styles.input })),
      React.createElement('div', null, React.createElement('label', { style: styles.label }, 'No. of Flights'), React.createElement('input', { type: 'number', value: numFlights, onChange: (e) => setNumFlights(parseFloat(e.target.value)), style: styles.input })),
    ...
    React.createElement('div', { style: styles.row6 },
      React.createElement('div', null, React.createElement('label', { style: styles.label }, 'Landing L (ft)'), React.createElement('input', { type: 'number', value: landingLength, onChange: (e) => setLandingLength(parseFloat(e.target.value)), style: styles.input })),
      React.createElement('div', null, React.createElement('label', { style: styles.label }, 'Landing W (ft)'), React.createElement('input', { type: 'number', value: landingWidth, onChange: (e) => setLandingWidth(parseFloat(e.target.value)), style: styles.input })),
    ...
    React.createElement('div', { style: styles.row4 },
      React.createElement('div', null, React.createElement('label', { style: styles.label }, 'X-Dir Dia (mm)'), React.createElement('input', { type: 'number', value: mainBarDia, onChange: (e) => setMainBarDia(parseFloat(e.target.value)), style: styles.input })),
      React.createElement('div', null, React.createElement('label', { style: styles.label }, 'X-Dir Spacing (mm)'), React.createElement('input', { type: 'number', value: mainBarSpacing, onChange: (e) => setMainBarSpacing(parseFloat(e.target.value)), style: styles.input })),
      React.createElement('div', null, React.createElement('label', { style: styles.label }, 'Y-Dir Dia (mm)'), React.createElement('input', { type: 'number', value: distBarDia, onChange: (e) => setDistBarDia(parseFloat(e.target.value)), style: styles.input })),
    ...
    React.createElement('div', { style: styles.row6 },
      ...
      React.createElement('div', null, React.createElement('label', { style: styles.label }, 'Railing L (ft)'), React.createElement('input', { type: 'number', value: railingLength, onChange: (e) => setRailingLength(parseFloat(e.target.value)), style: styles.input }))
    ),
