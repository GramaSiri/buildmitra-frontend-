  ...
  const handleDownloadPDF = () => {
    checkAndRun('calculator_export', 'rcc-slab-calculator', () => {
      ...
      downloadBuildMitraPDF({
        documentTitle: `BuildMitra RCC Slab & Beam Estimate (${calcMode.toUpperCase()})`,
  ...
  const handleShareWhatsApp = () => {
    checkAndRun('calculator_export', 'rcc-slab-calculator', () => {
      ...
      const msg = `*BuildMitra RCC Slab & Beam Calculator Report*%0A` +
        ...
        `----------------------------------------%0A` +
        `• *Total Concrete Volume*: ${formatNumber(res.totalVolCft)} CFT (${formatNumber(res.totalVolCum)} m³)%0A` +
        ...
        <>
          <div style={styles.stepperCard}>
            ...
            <div style={styles.noteBox}>
              💡 <strong>IS 456 Structural Standard</strong>: Concrete Volume = Built-Up Area x Slab Thickness + Monolithic Beam Volume Allowance (~12%). Steel Rebar density = 1.0% volume ratio.
            </div>
