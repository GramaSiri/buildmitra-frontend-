...
const GENERAL_APP_OVERVIEW: Record<string, string> = {
  ...
  'hi-IN': "बिल्डमित्रा सिविल निर्माण ऐप में आपका स्वागत है। बिल्डमित्रा भारत का प्रमुख डिजिटल प्लेटफॉर्म है जो भवन अनुमान, सरिया बीबीएस, सीमेंट-रेत मात्रा और लाइव दरों की गणना करता है। यह 15% तक सामग्री की बर्बादी को रोकता है।",
  ...
  'te-IN': "బిల్డ్ మిత్ర సివిల్ నిర్మాణ యాప్‌కు స్వాగతం. బిల్డ్ మిత్ర అనేది భవన అంచనాలు, స్టీల్ BBS, సిమెంట్-ఇసుక పరిమాణం మరియు లైవ్ ధరలను లెక్కిస్తుంది. ఇది నిర్మాణ వ్యయాన్ని 15% వరకు ఆదా చేస్తుంది.",
  'ta-IN': "பில்ட்மித்ரா சிவில் கட்டுமான செயலிகளுக்கு வரவேற்கிறோம். பில்ட்மித்ரா கட்டிட மதிப்பீடு, கம்பி BBS மற்றும் நேரலை விலைகளை துல்லியமாக கணக்கிடுகிறது.",
  'ml-IN': "ബിൽഡ് മിത്ര സിവിൽ നിർമ്മാണ ആപ്പിലേക്ക് സ്വാഗതം. ബിൽഡ് മിത്ര കെട്ടിട അഗ്രഗേറ്റുകൾ, കമ്പി BBS, സിമന്റ്-മണൽ അളവുകൾ എന്നിവ കൃത്യമായി കണക്കാക്കുന്നു.",
  ...
  'or-IN': "ବିଲ୍ଡମିତ୍ର ସିଭିଲ୍ ନିର୍ମାଣ ଆପ୍ କୁ ସ୍ୱାଗତ | ବିଲ୍ଡମିତ୍ର କୋଠା ଆକଳନ, ରଡ୍ BBS ଏବଂ ଲାଇଭ୍ ଦର ଗଣନା କରେ |"
};

const ITEM_NATIVE_NAMES: Record<string, Record<string, string>> = {
  "MAT-CEM-01": {
    "hi-IN": "सीमेंट",
    "kn-IN": "ಸಿಮೆಂಟ್",
    "te-IN": "సిమెంట్",
  ...
  "MAT-STL-01": {
    ...
    "kn-IN": "ಟಿಎಂಟಿ ಸ್ಟೀಲ್",
    "te-IN": "టిఎంటి స్టీల్",
    "ta-IN": "டிஎம்டி ஸ்டீல்",
    "ml-IN": "ടിഎംടി സ്റ്റീൽ",
    "bn-IN": "টিএমটি রড",
    "or-IN": "ଟିଏମଟି ରଡ୍"
  },
  "MAT-MSND-01": {
    "hi-IN": "एम-सैंड रेत",
    "kn-IN": "ಎಮ್-ಸ್ಯಾಂಡ್ ಮರಳು",
    "te-IN": "ఎం-శాండ్ ఇసుక",
    "ta-IN": "எம்-சாண்ட் மணல்",
    "ml-IN": "എം-സാൻഡ് മണൽ",
    "bn-IN": "এম-স্যান্ড বালু",
    "or-IN": "ଏମ-ସ୍ୟାଣ୍ଡ ବାଲି"
  },
  "MAT-AGG-20": {
    "hi-IN": "20 मिमी गिट्टी",
    "kn-IN": "20 ಎಂಎಂ ಜಲ್ಲಿ",
    "te-IN": "20 ఎంఎం జెల్లీ",
    "ta-IN": "20 எம்எம் ஜெல்லி",
    "ml-IN": "20 എംഎം ജെല്ലി",
    "bn-IN": "২০ মিমি পাথর",
    "or-IN": "୨୦ ମିମି ଗିଟି"
  },
  "MAT-BRK-01": {
  ...
  "MAT-BLK-01": {
    "hi-IN": "कंक्रीट ब्लॉक",
    "kn-IN": "ಕಾಂಕ್ರೀಟ್ ಬ್ಲಾಕ್",
    "te-IN": "కాంక్రీట్ బ్లాక్",
    "ta-IN": "கான்கிரீட் பிளாக்",
    "ml-IN": "കോൺക്രീറ്റ് ബ്ലോക്ക്",
    "bn-IN": "কনক্রিট ব্লক",
    "or-IN": "କଂକ୍ରିଟ୍ ବ୍ଲକ୍"
  },
  "MAT-PNT-01": {
    "hi-IN": "इमल्शन पेंट",
    "kn-IN": "ಎಮಲ್ಷನ್ ಪೇಂಟ್",
    "te-IN": "ఎమల్షన్ పెయింట్",
    "ta-IN": "எமல்ஷன் பெயிண்ட்",
    "ml-IN": "എമൽഷൻ പെയിന്റ്",
    "bn-IN": "ইমালশন রং",
    "or-IN": "ଇମଲସନ୍ ପେଣ୍ଟ"
  },
  "MAT-VIT-01": {
    "hi-IN": "विट्रिफाइड टाइल्स",
    "kn-IN": "ವಿಟ್ರಿಫೈಡ್ ಟೈಲ್ಸ್",
    "te-IN": "విట్రిఫైడ్ టైల్స్",
    "ta-IN": "விட்ரிஃபைட் டைல்ஸ்",
    "ml-IN": "വിട്രിഫൈഡ് ടൈലുകൾ",
    "bn-IN": "ভিট্রিফাইড টাইলস",
    "or-IN": "ଭିଟ୍ରିଫାଇଡ୍ ଟାଇଲ୍ସ"
  },
  "SRV-PLS-LAY": {
    "hi-IN": "प्लास्टर मजदूरी",
    "kn-IN": "ಪ್ಲಾಸ್ಟರಿಂಗ್ ಕೂಲಿ",
    "te-IN": "ప్లాస్టరింగ్ కూలీ",
    "ta-IN": "பூச்சு கூலி",
    "ml-IN": "പൂച്ച് പണി കൂലി",
    "bn-IN": "প্লাস্টারিং মজুরি",
    "or-IN": "ପ୍ଲାଷ୍ଟରିଂ ମଜୁରୀ"
  },
  "SRV-BBN-LAY": {
    "hi-IN": "बार बेंडिंग मजदूरी",
    "kn-IN": "ಬಾರ್ ಬೆಂಡಿಂಗ್ ಕೂಲಿ",
    "te-IN": "బార్ బెండింగ్ కూలీ",
    "ta-IN": "பார் பெண்டிங் கூலி",
    "ml-IN": "ബാർ ബെൻഡിംഗ് കൂലി",
    "bn-IN": "বার বেন্ডিং মজুরি",
    "or-IN": "ବାର୍ ବେଣ୍ଡିଂ ମଜୁରୀ"
  }
};

interface AppGuideModule {
  id: string;
  title: string;
  icon: string;
  path: string;
...
const FULL_APP_GUIDES: AppGuideModule[] = [
  {
    id: "steel",
    ...
    howToFill: {
      ...
      "hi-IN": "1. संरचनात्मक सदस्य चुनें। 2. लंबाई, चौड़ाई, गहराई दर्ज करें। 3. मुख्य निचली/ऊपरी छड़ का व्यास और संख्या दर्ज करें। 4. स्टिरअप व्यास और रिक्ति दर्ज करें। 5. गणना करें पर क्लिक करें।",
      ...
      "te-IN": "1. నిర్మాణాత్మక రకం ఎంచుకోండి (బీమ్, కాలమ్, స్లాబ్). 2. పొడవు, వెడల్పు, లోతు నమోదు చేయండి. 3. ప్రధాన రాడ్ వ్యాసం మరియు సంఖ్య నమోదు చేయండి. 4. రింగుల వ్యాసం మరియు దూరం నమోదు చేయండి. 5. లెక్కించు క్లిక్ చేయండి.",
      "ta-IN": "1. உறுப்பினர் வகை தேர்ந்தெடுக்கவும். 2. நீளம், அகலம், ஆழம் உள்ளிடவும். 3. கம்பி விட்டம் மற்றும் எண்ணிக்கை உள்ளிடவும். 4. ரிங் விட்டம் உள்ளிடவும். 5. கணக்கிடு கிளிக் செய்யவும்.",
      "ml-IN": "1. ടൈപ്പ് തിരഞ്ഞെടുക്കുക. 2. നീളം, വീതി, ആഴം നൽകുക. 3. കമ്പി വ്യാസവും എണ്ണവും നൽകുക. 4. റിംഗ് വ്യാസവും അകലവും നൽകുക. 5. കണക്കാക്കുക ക്ലിക്ക് ചെയ്യുക.",
      "bn-IN": "১. মেম্বার টাইপ চয়ন করুন। ২. দৈর্ঘ্য, প্রস্থ, গভীরতা দিন। ৩. রডের ব্যাস ও সংখ্যা দিন। ৪. স্টাইরাপের ব্যাস ও দূরত্ব দিন। ৫. ক্যালকুলেট ক্লিক করুন।",
      "or-IN": "୧. ପ୍ରକାର ବାଛନ୍ତୁ | ୨. ଲମ୍ବ, ଓସାର, ଗଭୀରତା ଦିଅନ୍ତୁ | ୩. ରଡ୍ ବ୍ୟାସ ଏବଂ ସଂଖ୍ୟା ଦିଅନ୍ତୁ | ୪. ରିଙ୍ଗ୍ ବ୍ୟାସ ଦିଅନ୍ତୁ | ୫. ଗଣନା କ୍ଲିକ୍ କରନ୍ତୁ |"
    },
    benefits: {
  ...
  },
  {
    ...
    where: {
      ...
      "bn-IN": "ফাউন্ডেশন, কলাম, বিম, ছাদ, সিঁড়ি এবং দেয়ালের জন্য।",
  ...
  },
  {
    ...
    where: {
      ...
      "te-IN": "బయటి 9-అంగుళాల గోడలు, లోపలి 4.5-అంగుళాల గోడలు మరియు కాంపౌండ్ గోడలకు.",
    ...
    whom: {
      ...
      "te-IN": "భవన మేస్త్రీలు, సివిల్ కాంట్రాక్టర్లు, ఇంటి యజమానులు.",
    ...
    howToFill: {
      ...
      "hi-IN": "1. दीवार के आयाम दर्ज करें: लंबाई और ऊंचाई। 2. दीवार की मोटाई चुनें। 3. ईंट का प्रकार चुनें। 4. दरवाजे और खिड़की की कटौती दर्ज करें। 5. कुल ईंट संख्या देखें।",
      ...
      "te-IN": "1. గోడ కొలతలు నమోదు చేయండి: పొడవు మరియు ఎత్తు. 2. గోడ మందం ఎంచుకోండి. 3. ఇటుక రకం ఎంచుకోండి. 4. తలుపు మరియు కిటికీ కోతలు నమోదు చేయండి. 5. ఇటుకల సంఖ్య చూడండి.",
      "ta-IN": "1. சுவர் அளவுகளை உள்ளிடவும். 2. சுவர் தடிமன் தேர்ந்தெடுக்கவும். 3. வகை தேர்ந்தெடுக்கவும். 4. கழிவு உள்ளிடவும். 5. மொத்த எண்ணிக்கை பார்க்கவும்.",
      ...
      "bn-IN": "১. দেয়ালের পরিমাপ দিন। ২. দেয়ালের পুরুত্ব চয়ন করুন। ৩. ইটের ধরন চয়ন করুন। ৪. দরজা-জানালা বাদ দিন। ৫. ইটের সংখ্যা দেখুন।",
      "or-IN": "୧. କାନ୍ଥ ପରିମାଣ ଦିଅନ୍ତୁ | ୨. କାନ୍ଥ ମୋଟେଇ ବାଛନ୍ତୁ | ୩. ଇଟା ପ୍ରକାର ବାଛନ୍ତୁ | ୪. କବାଟ-ଝରକା କଟା ଦିଅନ୍ତୁ | ୫. ଇଟା ସଂଖ୍ୟା ଦେଖନ୍ତୁ |"
    },
    benefits: {
...
const APP_MODULES = [
  {
    ...
    path: "/concrete-calculator",
    icon: "🧱",
    keywords: ["concrete calculator", "concrete", "rmc calculator", "slab", "column", "footing", "कंक्रीट", "ಕಾಂಕ್ರೀಟ್", "కాంక్రీట్", "கான்கிரீட்", "കോൺക്രീറ്റ്", "কনক্রিট", "କଂକ୍ରିଟ୍"],
    tips: {
      "en-IN": "Enter L, B, H in feet. Select grade. Get cement, sand, aggregate.",
      "hi-IN": "L, B, H दर्ज करें। ग्रेड चुनें। सीमेंट, रेत, समुच्चय प्राप्त करें।",
      "kn-IN": "L, B, H ನಮೂದಿಸಿ. ಗ್ರೇಡ್ ಆಯ್ಕೆಮಾಡಿ.",
      "te-IN": "L, B, H నమోదు చేయండి. గ్రేడ్ ఎంచుకోండి.",
      "ta-IN": "L, B, H உள்ளிடவும். தரத்தை தேர்ந்தெடுக்கவும்.",
      "ml-IN": "L, B, H നൽകുക. ഗ്രേഡ് തിരഞ്ഞെടുക്കുക.",
      "bn-IN": "L, B, H দিন। গ্রেড নির্বাচন করুন।",
      "or-IN": "L, B, H ଦିଅନ୍ତୁ | ଗ୍ରେଡ୍ ବାଛନ୍ତୁ |"
    }
  },
  {
    id: "steel",
    ...
    path: "/steel-calculator",
    icon: "🏗️",
    keywords: ["steel calculator", "steel", "rebar", "tmt bars", "sariya", "स्टी़ल", "ಸ್ಟೀಲ್", "ಸ್ಟಿಲ್", "స్టీల్", "స్టోల్", "ஸ்டீல்", "സ്റ്റീൽ", "ইস্পাত", "ଷ୍ଟିଲ୍"],
    tips: {
      "en-IN": "Enter rod diameter, length, quantity. Get weight.",
      "hi-IN": "छड़ व्यास, लंबाई, मात्रा दर्ज करें। वजन प्राप्त करें।",
      "kn-IN": "ರಾಡ್ ವ್ಯಾಸ, ಉದ್ದ, ಪ್ರಮಾಣ ನಮೂದಿಸಿ.",
      "te-IN": "రాడ్ వ్యాసం, పొడవు, परिमाण నమోదు చేయండి.",
      "ta-IN": "ராட் விட்டம், நீளம், அளவு உள்ளிடவும்.",
      "ml-IN": "റോഡ് വ്യാസം, നീളം, അളവ് നൽകുക.",
      "bn-IN": "রড ব্যাস, দৈর্ঘ্য, পরিমাণ দিন।",
      "or-IN": "ରଡ୍ ବ୍ୟାସ, ଲମ୍ବ, ପରିମାଣ ଦିଅନ୍ତୁ |"
    }
  }
];

export default function HandsFreeVoiceGuide() {
  ...
  const [matchedModule, setMatchedModule] = useState<any>(null);
  const [similarMaterials, setSimilarMaterials] = useState<any[]>([]);
  const [statusMessage, setStatusMessage] = useState("Loading live rates...");
  const [materials, setMaterials] = useState<MaterialItem[]>([]);
  const [totalMaterials, setTotalMaterials] = useState(0);
  const [activeGuideId, setActiveGuideId] = useState("steel");
  const [isNarratingApp, setIsNarratingApp] = useState(false);

  const recognitionRef = useRef<any>(null);

  const loadMaterials = () => {
    syncApprovedRatesFromBackend();
    const liveItems = getAllLiveMasterItems();
    setMaterials(liveItems);
    setTotalMaterials(liveItems.length);
    setStatusMessage(`Loaded ${liveItems.length} Admin Approved rates across 8 languages.`);
  };
  ...
  const playFullVoiceNarration = () => {
    ...
    if (isNarratingApp) {
      ...
      setIsNarratingApp(false);
      return;
    }

    window.speechSynthesis.cancel();

    const currentGuide = FULL_APP_GUIDES.find(g => g.id === activeGuideId) || FULL_APP_GUIDES[0];
    ...
    utterance.onstart = () => setIsNarratingApp(true);
    utterance.onend = () => setIsNarratingApp(false);
    utterance.onerror = () => setIsNarratingApp(false);
  ...
  const getItemDisplayName = (item: MaterialItem, lang: string): string => {
    if (ITEM_NATIVE_NAMES[item.code] && ITEM_NATIVE_NAMES[item.code][lang]) {
      return ITEM_NATIVE_NAMES[item.code][lang];
    }
  ...
  const processQuery = (query: string) => {
    ...
    const liveItems = materials.length > 0 ? materials : getAllLiveMasterItems();
    
    const material = searchMaterial(liveItems, cleanQuery);
    
    if (material) {
      setMatchedMaterial(material);
      setMatchedModule(null);
      
      const keyword = cleanSearchQuery(cleanQuery);
      const allMatches = getMaterialsByKeyword(liveItems, keyword, 10);
      setSimilarMaterials(allMatches.filter(i => i.code !== material.code));
      
      const nativeName = getItemDisplayName(material, selectedLang);
      const rateInfo = `₹${material.rate.toLocaleString('en-IN')} per ${material.unit}`;
      const totalInfo = material.gst ? ` (incl ${material.gst}% GST: ₹${(material.rate * (1 + material.gst / 100)).toLocaleString('en-IN')})` : "";
      
      let reply = "";
      switch (selectedLang) {
        case "hi-IN":
          reply = `${nativeName} की आज की BuildMitra स्वीकृत दर ${rateInfo} है।`;
          break;
        case "kn-IN":
          reply = `${nativeName} ಇಂದಿನ BuildMitra ಅನುಮೋದಿತ ದರ ${rateInfo}.`;
          break;
        case "te-IN":
          reply = `${nativeName} ఈరోజు BuildMitra ఆమోదించిన ధర ${rateInfo}.`;
          break;
        case "ta-IN":
          reply = `${nativeName} இன்றைய BuildMitra அங்கீகரிக்கப்பட்ட விலை ${rateInfo}.`;
          break;
        case "ml-IN":
          reply = `${nativeName} ഇന്നത്തെ BuildMitra അംഗീകരിച്ച നിരക്ക് ${rateInfo} ആണ്.`;
          break;
        case "bn-IN":
          reply = `${nativeName} আজকের BuildMitra অনুমোদিত দর ${rateInfo}।`;
          break;
        case "or-IN":
          reply = `${nativeName} ଆଜିର BuildMitra ଅନୁମୋଦିତ ଦର ${rateInfo} |`;
          break;
        default:
          reply = `Today's BuildMitra Admin Approved rate for ${nativeName} is ${rateInfo}${totalInfo}.`;
      }
      
      setStatusMessage(`Found: ${nativeName} — ${rateInfo}`);
      speak(reply, selectedLang);
    } else {
      const module = APP_MODULES.find(m => 
        m.keywords.some(k => cleanQuery.includes(k.toLowerCase()))
      );
      ...
      if (module) {
        ...
        setSimilarMaterials([]);
        const tips = module.tips[selectedLang] || module.tips["en-IN"];
        const reply = `Opening ${module.title}. ${tips}`;
        
        setStatusMessage(`Navigating to: ${module.title}`);
        speak(reply, selectedLang);
      ...
      switch (selectedLang) {
        case "hi-IN":
          reply = `क्षमा करें, "${query}" के लिए कोई स्वीकृत दर नहीं मिली। अधिक जानकारी के लिए BuildMitra Marketplace देखें।`;
          break;
        case "kn-IN":
          reply = `ಕ್ಷಮಿಸಿ, "${query}" ಗೆ ಅನುಮೋದಿತ ದರ ಸಿಗಲಿಲ್ಲ. ಹೆಚ್ಚಿನ ವಿವರಗಳಿಗಾಗಿ BuildMitra Marketplace ನೋಡಿ.`;
          break;
        case "te-IN":
          reply = `క్షమించండి, "${query}" కి ఆమోదించిన ధర దొరకలేదు. మరిన్ని వివరాలకు BuildMitra Marketplace చూడండి.`;
          break;
        case "ta-IN":
          reply = `மன்னிக்கவும், "${query}" க்கு அங்கீகரிக்கப்பட்ட விலை கிடைக்கவில்லை. மேலும் விவரங்களுக்கு BuildMitra Marketplace பார்க்கவும்.`;
          break;
        case "ml-IN":
          reply = `ക്ഷമിക്കണം, "${query}" നായി അംഗീകരിച്ച നിരക്ക് ലഭ്യമല്ല. കൂടുതൽ വിവരങ്ങൾക്ക് BuildMitra Marketplace പരിശോധിക്കുക.`;
          break;
        case "bn-IN":
          reply = `দুঃখিত, "${query}" এর জন্য কোনো অনুমোদিত দর পাওয়া যায়নি। বিবরণ দেখতে BuildMitra Marketplace দেখুন।`;
          break;
        case "or-IN":
          reply = `କ୍ଷମା କରିବେ, "${query}" ପାଇଁ କୌଣସି ଅନୁମୋଦିତ ଦର ମିଳିଲା ନାହିଁ | ଅଧିକ ସୂଚନା ପାଇଁ BuildMitra Marketplace ଦେଖନ୍ତୁ |`;
          break;
        default:
          reply = `Sorry, no exact Admin Approved rate found for "${query}". For further details, check BuildMitra Marketplace.`;
      }
  ...
  const startListening = () => {
    ...
    try {
      ...
      recognition.onstart = () => {
        setIsListening(true);
        setStatusMessage(`Listening in ${selectedLang}... Speak now.`);
      };
      ...
      recognition.onresult = (event: any) => {
        ...
        for (let i = event.resultIndex; i < event.results.length; i++) {
          ...
          if (event.results[i].isFinal) finalTrans += trans + " ";
          else interimTrans += trans;
        }
        if (finalTrans) {
          const combined = finalTrans.trim();
          setTranscript(combined);
          processQuery(combined);
          setTimeout(() => {
            setTranscript("");
      ...
      setIsListening(false);
      setStatusMessage("Could not start voice recognition.");
    }
  };

  const activeLang = SUPPORTED_LANGUAGES.find(l => l.code === selectedLang) || SUPPORTED_LANGUAGES[0];
  const activeGuide = FULL_APP_GUIDES.find(g => g.id === activeGuideId) || FULL_APP_GUIDES[0];

  return (
    <>
      <Head>
        <title>BuildMitra Voice Assistant &amp; Multi-Lingual App Guide</title>
      </Head>

      <div style={{ padding: "10px", maxWidth: "1200px", margin: "0 auto", fontFamily: "Segoe UI, -apple-system, sans-serif", minHeight: "100vh", backgroundColor: "#f8fafc" }}>
        
        {/* TOP HEADER WITH FULL APP GUIDE BANNER */}
        <div style={{
          ...
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "8px", flexWrap: "wrap", gap: "8px" }}>
            <span style={{ background: "rgba(255, 255, 255, 0.15)", border: "1px solid rgba(255, 255, 255, 0.3)", color: "#ffffff", padding: "4px 10px", borderRadius: "20px", fontSize: "11px", fontWeight: "800" }}>
              🎙️ 8 REGIONAL LANGUAGES VOICE ASSISTANT &amp; APP GUIDE
            </span>
            <button
              onClick={() => { if (isSpeaking) stopSpeaking(); setIsMuted(!isMuted); }}
              style={{ background: isMuted ? "#ef4444" : "rgba(255,255,255,0.2)", color: "#fff", border: "1px solid rgba(255,255,255,0.3)", padding: "6px 14px", borderRadius: "20px", fontSize: "12px", fontWeight: "bold", cursor: "pointer" }}
            >
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: "16px", marginBottom: "20px" }}>
          <div style={{ background: "#fff", borderRadius: "16px", padding: "16px", border: "1px solid #e2e8f0", boxShadow: "0 4px 12px rgba(0,0,0,0.03)" }}>
            <h3 style={{ margin: "0 0 10px 0", fontSize: "15px", color: "#1e293b", fontWeight: "800" }}>🌐 Select Regional Language</h3>
            
            {/* HIGHLIGHTED BOX NEXT TO LANGUAGE SELECTION */}
            <div style={{
              ...
              <select
                value={selectedLang}
                onChange={(e) => { setSelectedLang(e.target.value); stopSpeaking(); stopVoiceNarration(); }}
                style={{ width: "100%", padding: "10px 12px", borderRadius: "8px", border: "1px solid #38bdf8", fontSize: "14px", fontWeight: 800, marginBottom: "10px", cursor: "pointer", background: "#0f172a", color: "#38bdf8" }}
              >
              ...
              <button
                ...
                style={{
                  ...
                  borderRadius: "8px",
                  border: "none",
                  background: isNarratingApp ? "#ef4444" : "#16a34a",
                  color: "#fff",
                  fontSize: "13px",
                  fontWeight: 800,
                  cursor: "pointer",
              ...
              >
                {isNarratingApp ? "⏹️ Stop Narration" : `🔊 Play Full Voice Narration (${activeLang.nativeName})`}
              </button>
            </div>

            <button
              onClick={() => isListening ? recognitionRef.current?.stop() : startListening()}
              style={{ width: "100%", padding: "14px", borderRadius: "12px", border: "none", background: isListening ? "#ef4444" : "#0284c7", color: "#fff", fontSize: "15px", fontWeight: 800, cursor: "pointer", marginBottom: "10px", minHeight: "50px", boxShadow: "0 4px 12px rgba(2, 132, 199, 0.3)" }}
            >
              {isListening ? "🔴 Listening... Speak Now" : `🎙️ Speak Rate Query (${activeLang.nativeName})`}
            </button>
            <div style={{ fontSize: "12px", color: "#0284c7", fontWeight: "700" }}>{statusMessage}</div>
            {(transcript || interimTranscript) && (
              <div style={{ marginTop: "12px", padding: "10px", background: "#f1f5f9", borderRadius: "8px", borderLeft: "4px solid #0284c7", fontSize: "13px", color: "#0f172a" }}>
                🗣️ <em>"{transcript || interimTranscript}"</em>
              </div>
            )}
          </div>

          <div style={{ background: "#fff", borderRadius: "16px", padding: "16px", border: "1px solid #e2e8f0", boxShadow: "0 4px 12px rgba(0,0,0,0.03)" }}>
            <h3 style={{ margin: "0 0 10px 0", fontSize: "15px", color: "#1e293b", fontWeight: "800" }}>🔍 Voice Query Results &amp; Live Rate</h3>
            {matchedMaterial ? (
              <div style={{ background: "#f0fdf4", border: "2px solid #22c55e", padding: "14px", borderRadius: "12px" }}>
                <div style={{ fontSize: "11px", color: "#15803d", fontWeight: "800", textTransform: "uppercase" }}>Master Item Code: {matchedMaterial.code}</div>
                <div style={{ fontSize: "18px", fontWeight: "800", color: "#0f172a", marginTop: "4px" }}>
                  {getItemDisplayName(matchedMaterial, selectedLang)} ({matchedMaterial.itemName})
                </div>
                <div style={{ fontSize: "20px", fontWeight: "900", color: "#16a34a", marginTop: "6px" }}>₹{matchedMaterial.rate.toLocaleString('en-IN')} / {matchedMaterial.unit}</div>
                <div style={{ fontSize: "12px", color: "#475569", marginTop: "4px" }}>GST: {matchedMaterial.gst}% | Category: {matchedMaterial.category} ({matchedMaterial.subCategory})</div>
                <div style={{ fontSize: "11px", color: "#0369a1", fontWeight: "700", marginTop: "6px" }}>Source: {matchedMaterial.source || "BuildMitra Admin Master Store"}</div>
              </div>
            ) : matchedModule ? (
              <div style={{ background: "#eff6ff", border: "2px solid #3b82f6", padding: "14px", borderRadius: "12px" }}>
                <div style={{ fontSize: "24px" }}>{matchedModule.icon}</div>
                <div style={{ fontSize: "18px", fontWeight: "800", color: "#1e40af" }}>Opening {matchedModule.title}...</div>
                <div style={{ fontSize: "13px", color: "#1e3a8a", marginTop: "4px" }}>{matchedModule.tips[selectedLang] || matchedModule.tips["en-IN"]}</div>
              </div>
            ) : (
              <div style={{ color: "#64748b", fontSize: "13px", fontStyle: "italic", padding: "20px", textAlign: "center", border: "2px dashed #cbd5e1", borderRadius: "12px" }}>
                Ask any question like "TMT steel price", "सीमेंट दर", "ಸಿಮೆಂಟ್ ದರ", "సిమెంట్ ధర", "சிமெண்ட் விலை", "സിമന്റ് നിരക്ക്", "সিমেন্টের দাম", "ସିମେଣ୍ଟ ଦର".
              </div>
            )}
          </div>
        </div>

        {/* INLINE DEDICATED BUILDMITRA APP GUIDE SECTION (WITH GENERAL OVERVIEW & VOICE NARRATION) */}
        <div style={{
          ...
          <div style={{ backgroundColor: "#0f172a", color: "#ffffff", padding: "16px", borderRadius: "12px", marginBottom: "16px", borderLeft: "4px solid #38bdf8" }}>
            <div style={{ fontSize: "12px", fontWeight: "800", color: "#38bdf8", textTransform: "uppercase" }}>🏢 General BuildMitra Suite Overview ({activeLang.nativeName})</div>
          ...
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "16px", flexWrap: "wrap", gap: "10px" }}>
            <div>
              <span style={{ background: "#0284c7", color: "#fff", padding: "3px 10px", borderRadius: "12px", fontSize: "11px", fontWeight: "800" }}>
                💡 COMPLETE APPLICATION GUIDE
              </span>
              <h2 style={{ fontSize: "20px", fontWeight: "800", color: "#0f172a", margin: "4px 0 0 0" }}>
                BuildMitra App Explanation — Why, Where, When, Whom &amp; How ({activeLang.nativeName})
              </h2>
            </div>

            {/* TAB SELECTOR FOR MODULES */}
            <div style={{ display: "flex", gap: "6px", flexWrap: "wrap" }}>
              {FULL_APP_GUIDES.map(guide => (
                <button
                  key={guide.id}
                  onClick={() => { setActiveGuideId(guide.id); stopVoiceNarration(); }}
                  style={{
                    padding: "6px 12px",
                    borderRadius: "8px",
                    border: activeGuideId === guide.id ? "2px solid #0284c7" : "1px solid #cbd5e1",
                    backgroundColor: activeGuideId === guide.id ? "#f0f9ff" : "#ffffff",
                    color: activeGuideId === guide.id ? "#0284c7" : "#475569",
                    fontWeight: activeGuideId === guide.id ? "800" : "600",
                    fontSize: "12px",
                    cursor: "pointer"
                  }}
                >
          ...
          {/* ACTIVE MODULE HYPE & BENEFITS BANNER */}
          <div style={{ backgroundColor: "#f0fdf4", border: "1px solid #bbf7d0", color: "#166534", padding: "12px 16px", borderRadius: "10px", marginBottom: "16px", fontSize: "13px", fontWeight: "700" }}>
            {activeGuide.benefits[selectedLang] || activeGuide.benefits["en-IN"]}
          </div>

          {/* 5-W's NARRATIVE GRID */}
          ...
          <div style={{ padding: "16px", borderRadius: "12px", backgroundColor: "#f0f9ff", border: "2px solid #0284c7", display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: "10px" }}>
            <div>
              <div style={{ fontSize: "14px", fontWeight: "800", color: "#0369a1" }}>✍️ How to Fill User Input Fields ({activeLang.nativeName}):</div>
            ...
            <button
              ...
              style={{ backgroundColor: "#0284c7", color: "#fff", border: "none", borderRadius: "8px", padding: "8px 16px", fontSize: "13px", fontWeight: "800", cursor: "pointer", whiteSpace: "nowrap" }}
            >
              Open {activeGuide.title} →
            </button>
          </div>
        </div>
        ...
        {similarMaterials.length > 0 && (
          <div style={{ background: "#fff", borderRadius: "16px", padding: "16px", border: "1px solid #e2e8f0" }}>
            <h3 style={{ margin: "0 0 12px 0", fontSize: "15px", color: "#1e293b", fontWeight: "800" }}>📦 Related Approved Master Items ({similarMaterials.length})</h3>
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(200px, 1fr))", gap: "10px" }}>
              {similarMaterials.map(item => (
                <div key={item.code} style={{ padding: "10px", borderRadius: "10px", border: "1px solid #e2e8f0", background: "#f8fafc" }}>
                  <div style={{ fontSize: "11px", color: "#0284c7", fontWeight: "800" }}>{item.code}</div>
                  <div style={{ fontSize: "13px", fontWeight: "800", color: "#0f172a" }}>{getItemDisplayName(item, selectedLang)}</div>
                  <div style={{ fontSize: "14px", fontWeight: "800", color: "#16a34a", marginTop: "2px" }}>₹{item.rate.toLocaleString('en-IN')} / {item.unit}</div>
                </div>
              ))}
            </div>
          </div>
