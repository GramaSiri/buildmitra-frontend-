...
const router = useRouter();
  ...
  const coverBlock = getMasterRate(["cover block"], 5);
  const water = getMasterRate(["water"], 0.5, ["bm_service_rates", "bm_material_rates"]);
  const labour = getMasterRate(["retaining wall labour", "rcc labour", "concrete labour"], 1000, ["bm_labour_rates", "bm_service_rates"]);
  ...
  return (
    <div style={styles.page}>
      ...
      <div style={{ textAlign: "center" }}>
        ...
        {result && <button style={{ ...styles.btn, background: "#28a745" }} onClick={() => checkAndRun('calculator_export', 'retaining-wall-calculator', exportExcel)}>📊 Excel</button>}
