...
export default function RetainingWallCalculator() {
  ...
  const [thicknessFt, setThicknessFt] = useState(0);
      ...
      <div style={styles.container}>
        ...
        <div style={styles.card}>
          ...
          <div className="bm-boq-actions" style={{ marginTop: '12px' }}>
            ...
            <button style={styles.btnReset} onClick={() => { setLengthFt(0); setHeightFt(0); setThicknessFt(0); setHasCalculated(false); }}>🔄 Reset</button>
        ...
        {!hasCalculated ? (
          <div style={{
            ...
            <div style={{ fontSize: "16px", fontWeight: "800", color: "#0f172a", marginBottom: "6px" }}>Ready for Retaining Wall Estimation</div>
            <div style={{ fontSize: "13px", color: "#475569" }}>Please enter retaining wall dimensions &amp; rebar spacing above and click <strong>"⚡ Calculate Retaining Wall"</strong> to view material quantities &amp; itemized BOQ.</div>
          </div>
        ) : (
          <>
            {/* Result Metric Cards */}
