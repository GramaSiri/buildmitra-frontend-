...
useEffect(() => {
  ...
  const [completedProjects, setCompletedProjects] = useState([
    { 
      id: 101, 
      projectUniqueId: "COMP-001",
      name: "Sai Residency", 
      clientName: "Mr. Amit Patel", 
      location: "Borivali, Mumbai", 
      completionDate: "2023-12-15", 
      totalValue: 12500000, 
      testimonial: "Excellent work quality",
      images: [],
      documents: []
    },
    { 
      id: 102, 
      projectUniqueId: "COMP-002",
      name: "Shreeji Complex", 
      clientName: "Mrs. Rekha Shah", 
