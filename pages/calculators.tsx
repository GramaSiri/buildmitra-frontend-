...
const ALL_20_CALCULATORS: CalcItem[] = [
  { id: 'housing-loan-finance', name: 'Loan Calculator Hub', icon: '🏦', category: 'Land & Survey', unitBadge: 'Acres', description: 'FOIR & LTV Eligibility, EMI Amortization, 6 Major Banks Matrix, RBI Repo Simulator & Prepayment Saver.' },
