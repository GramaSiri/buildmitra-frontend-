  ...
  return (
    <div style={styles.container}>
      ...
      <div style={{ margin: "16px 0", display: "flex", gap: 10 }}>
        ...
        <button onClick={exportExcel} style={{ ...styles.btn, background: "#28a745" }}>📊 Excel</button>
        <button onClick={shareWhatsApp} style={{ ...styles.btn, background: "#25D366" }}>💬 Share</button>
      </div>
