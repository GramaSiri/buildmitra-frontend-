...
const styles = {
  ...
  header: { backgroundColor: '#2d6a4f', padding: '12px', borderRadius: '8px', marginBottom: '15px', color: 'white', display: 'flex', alignItems: 'center', gap: '10px' },
  ...
  th: { backgroundColor: '#2d6a4f', color: 'white', padding: '8px', textAlign: 'left' },
