      ...
      React.createElement("div", { style: styles.grid2 },
        React.createElement("div", { style: styles.card },
          ...
          React.createElement("div", { style: { padding: "20px" } },
            ...
            React.createElement("div", { style: styles.progressBar }, React.createElement("div", { style: { ...styles.progressFill, width: `${totalProperties ? (available / totalProperties) * 100 : 0}%`, backgroundColor: "#10b981" } })),
            React.createElement("div", null, React.createElement("strong", null, "Booked/Sold:"), " ", totalProperties - available, " properties"),
            React.createElement("div", { style: styles.progressBar }, React.createElement("div", { style: { ...styles.progressFill, width: `${totalProperties ? ((totalProperties - available) / totalProperties) * 100 : 0}%`, backgroundColor: "#f59e0b" } }))
          )
        ),
        React.createElement("div", { style: styles.card },
