...
const isReadOnly = false;
  ...
  const getCurrentAppUser = () => {
    try {
      return JSON.parse((sessionStorage.getItem("currentUser") || localStorage.getItem("currentUser")) || (sessionStorage.getItem("loggedInUser") || localStorage.getItem("loggedInUser")) || (sessionStorage.getItem("user") || localStorage.getItem("user")) || "{}");
    } catch {
      return {};
    }
  };
