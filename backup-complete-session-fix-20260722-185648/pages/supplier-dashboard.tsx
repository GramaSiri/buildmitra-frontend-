...
const [userName, setUserName] = useState("Supplier");
  ...
  useEffect(() => {
    ...
    const user = (sessionStorage.getItem("currentUser") || localStorage.getItem("currentUser")) || (sessionStorage.getItem("loggedInUser") || localStorage.getItem("loggedInUser")) || (sessionStorage.getItem("user") || localStorage.getItem("user"));
    if (user) {
      const userData = JSON.parse(user);
      const resolvedUserCode =
        userData.userCode ||
        userData.uniqueCode ||
        (sessionStorage.getItem("uniqueCode") || localStorage.getItem("uniqueCode")) ||
        "";
...
4. Subject to Bengaluru jurisdiction.`,
  ...
  const addProduct = () => {
    ...
    const user =
      JSON.parse((sessionStorage.getItem("currentUser") || localStorage.getItem("currentUser")) || "null") ||
      JSON.parse((sessionStorage.getItem("loggedInUser") || localStorage.getItem("loggedInUser")) || "null") ||
