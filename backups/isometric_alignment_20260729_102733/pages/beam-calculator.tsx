  ...
  const handleShareWhatsApp = () => {
    checkAndRun('calculator_export', 'beam-calculator', () => {
      const msg = `*BuildMitra RCC Beam Structural Report*%0A` +
        ...
        `----------------------------------------%0A` +
        `â€¢ *Beams*: ${inputs.beamNos} Nos (${inputs.widthIn}"x${inputs.depthIn}" x ${inputs.lengthFt}ft - ${inputs.grade})%0A` +
    ...
    <div style={styles.container}>
      ...
      <div style={styles.header}>
        ...
        <h1 style={styles.headerTitle}>
          ðŸ“Š RCC Beam Structural & Formwork Calculator
      ...
      <MarketRateTrend />
      <EngineeringSpecimen kind="beam" title="Dynamic Beam Specimen" material={inputs.grade} data={{ lengthFt: inputs.lengthFt, widthIn: inputs.widthIn, depthIn: inputs.depthIn, grade: inputs.grade, topDia: inputs.topDia, bottomDia: inputs.bottomDia, stirrupDia: inputs.stirrupDia, spacingMm: inputs.spacingMm }} />
      ...
      <div style={styles.dropdownCard}>
        ...
        >
          <option value="both">ðŸ”µ Both Concrete Materials & Steel Rebar (Complete RCC Beam)</option>
      ...
      <div style={styles.stepperCard}>
        <div style={styles.sectionHeader}>
          <span>ðŸ“ Beam Geometry & Structural Specifications</span>
        </div>

        <div style={styles.noteBox}>
          ðŸ’¡ <strong>IS 456 Structural Beam Standards</strong>: Select whether to compute Concrete Materials, Steel Rebar, or Both. Includes nominal mix proportions, top & bottom bar anchorage lengths, stirrup 135Â° hooks, 25mm clear cover, and beam soffit/side formwork shuttering.
        </div>
        ...
        {calcResults.hasSteel && (
          <div style={{ backgroundColor: '#fff5f7', padding: '14px', borderRadius: '8px', marginBottom: '16px', border: '1px solid #fecdd3' }}>
            <div style={{ fontSize: '13px', fontWeight: '700', color: '#800020', marginBottom: '10px' }}>ðŸ”„ Top & Bottom Longitudinal Reinforcement</div>
            <div style={styles.grid4}>
              <div style={styles.fieldGroup}>
        ...
        {calcResults.hasSteel && (
          <div style={{ backgroundColor: '#f0fdf4', padding: '14px', borderRadius: '8px', marginBottom: '16px', border: '1px solid #bbf7d0' }}>
            <div style={{ fontSize: '13px', fontWeight: '700', color: '#166534', marginBottom: '10px' }}>ðŸ”„ Shear Stirrups & Cover Controls</div>
        ...
        <div style={{ display: 'flex', justifyContent: 'flex-end', marginTop: '10px' }}>
          <button style={styles.btnReset} onClick={handleReset}>ðŸ”„ Reset Beam Form</button>
        </div>
      </div>
      ...
      <div style={styles.stepperCard}>
        <div style={styles.sectionHeader}>
          <span>ðŸ“Š Beam Results BOQ ({scopeOption === 'both' ? 'Concrete & Steel' : scopeOption === 'concrete_only' ? 'Concrete & Formwork' : 'Steel Rebar Only'})</span>
        </div>
