...
export default function PlasterCalculator() {
  ...
  const waterRate = getMasterRate(["MAT-WTR-01", "construction water", "water"], 0.05); // â‚¹0.05 per Litre
  ...
  const handleShareWhatsApp = () => {
    checkAndRun('calculator_export', 'plaster-calculator', () => {
      ...
      const msg = `*BuildMitra Plaster Calculator Report*%0A` +
        ...
        `----------------------------------------%0A` +
        `â€¢ *Net Plaster Area*: ${formatNumber(res.netArea)} Sqft%0A` +
        `â€¢ *Cement (50kg OPC 53)*: ${formatNumber(res.cemBags)} Bags%0A` +
        `â€¢ *M-Sand / P-Sand*: ${formatNumber(res.sandCft)} CFT%0A` +
    ...
    <div style={styles.container}>
      ...
      <div style={styles.dropdownCard}>
        ...
        >
          ...
          <option value="detailed">ðŸ“ Detailed Wall-Wise Calculation (Exact Room Dimensions & IS 1200 Deductions)</option>
        </select>
      </div>
        ...
        <>
          <div style={styles.stepperCard}>
            <div style={styles.sectionHeader}>
              <span>âš¡ Quick Calculation (Plot Dimensions & BUA Civil Thumb Rule)</span>
            </div>

            <div style={styles.noteBox}>
              ðŸ’¡ <strong>Civil Engineering Thumb Rule</strong>: Built-Up Area (BUA) = Plot Length x Plot Width x Floors. Plasterable Surface Area (Walls & Ceilings) = BUA x 3.5 Sqft.
            </div>
          ...
          <div style={styles.stepperCard}>
            <div style={styles.sectionHeader}>
              <span>ðŸ“Š Plaster Calculation Results & Materials BOQ</span>
            </div>
      ...
      {calcMode === 'detailed' && (
        <div style={styles.stepperCard}>
          <div style={styles.sectionHeader}>
            <span>ðŸ“ Detailed Wall-Wise Plaster Calculation Inputs (IS 1661 & IS 1200 Exact Rules)</span>
          </div>
          ...
          <div style={{ backgroundColor: '#f1f5f9', padding: '12px', borderRadius: '8px', marginBottom: '16px' }}>
            <div style={{ fontSize: '13px', fontWeight: '700', color: '#0f766e', marginBottom: '8px' }}>ðŸšª Openings Deduction (IS 1200 Part 12 Standard Rules)</div>
            <div style={styles.grid4}>
              <div style={styles.fieldGroup}>
          ...
          <div style={{ marginTop: '16px' }}>
            <div style={styles.sectionHeader}>
              <span>ðŸ“Š Detailed Plaster Calculation Results & Materials BOQ</span>
            </div>
