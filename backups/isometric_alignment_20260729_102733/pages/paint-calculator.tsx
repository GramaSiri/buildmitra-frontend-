  ...
  const handleShareWhatsApp = () => {
    checkAndRun(() => {
      ...
      const msg = `*BuildMitra Paint Calculator Report*%0A` +
        ...
        `----------------------------------------%0A` +
        `â€¢ *Net Paint Area*: ${formatNumber(calcMode === 'quick' ? quickCalcResults.paintableArea : detailedCalcResults.totalPaintArea)} Sqft%0A` +
  ...
  return (
    <div style={styles.container}>
      ...
      <div style={styles.dropdownCard}>
        ...
        >
          <option value="quick">âš¡ Quick Calculation (Estimate from Total Surface or Built-Up Area)</option>
          <option value="detailed">ðŸ“ Detailed Wall-Wise Calculation (Exact Room & Opening Measurements)</option>
        </select>
      </div>
        ...
        <>
          <div style={styles.stepperCard}>
            <div style={styles.sectionHeader}>
              <span>âš¡ Quick Paint Calculation Inputs</span>
            </div>

            <div style={styles.noteBox}>
              ðŸ’¡ <strong>IS 2395 Recommendations & Standards</strong>:
              <br />â€¢ <strong>External Painting</strong>: Exterior Weatherproof Primer + Exterior Weatherproof Emulsion.
              <br />â€¢ <strong>Internal Painting</strong>: Interior Putty (2 Coats ~0.10 kg/sqft) + Interior Primer + Acrylic / Royal Emulsion.
            </div>
          ...
          <div style={styles.stepperCard}>
            <div style={styles.sectionHeader}>
              <span>ðŸ“Š Paint Calculation Results & Materials BOQ</span>
            </div>
      ...
      {calcMode === 'detailed' && (
        <div style={styles.stepperCard}>
          <div style={styles.sectionHeader}>
            <span>ðŸ“ Detailed Wall-Wise Paint Calculation Inputs</span>
          </div>
          ...
          <div style={{ backgroundColor: '#f1f5f9', padding: '12px', borderRadius: '8px', marginBottom: '16px' }}>
            <div style={{ fontSize: '13px', fontWeight: '700', color: '#0f766e', marginBottom: '8px' }}>ðŸšª Openings (Doors & Windows Deduction & Enamel Paint)</div>
            <div style={styles.grid4}>
              <div style={styles.fieldGroup}>
          ...
          <div style={{ backgroundColor: '#f1f5f9', padding: '12px', borderRadius: '8px', marginBottom: '16px' }}>
            <div style={{ fontSize: '13px', fontWeight: '700', color: '#0f766e', marginBottom: '8px' }}>ðŸŽ¨ Special / Texture Design Paints</div>
            <div style={styles.grid3}>
              <div style={styles.fieldGroup}>
          ...
          <div style={{ marginTop: '16px' }}>
            <div style={styles.sectionHeader}>
              <span>ðŸ“Š Detailed Paint Calculation Results & Materials BOQ</span>
            </div>
