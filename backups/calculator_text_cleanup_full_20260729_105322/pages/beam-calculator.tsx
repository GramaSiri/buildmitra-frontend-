  ...
  const handleShareWhatsApp = () => {
    checkAndRun('calculator_export', 'beam-calculator', () => {
      const msg = `*BuildMitra RCC Beam Structural Report*%0A` +
        ...
        `----------------------------------------%0A` +
        `Ã¢â‚¬Â¢ *Beams*: ${inputs.beamNos} Nos (${inputs.widthIn}"x${inputs.depthIn}" x ${inputs.lengthFt}ft - ${inputs.grade})%0A` +
...
{/* 1. Header */}
      <div style={styles.header}>
        ...
        <h1 style={styles.headerTitle}>
          Ã°Å¸â€œÅ  RCC Beam Structural & Formwork Calculator
      ...
      <div style={styles.dropdownCard}>
        ...
        >
          <option value="both">Ã°Å¸â€Âµ Both Concrete Materials & Steel Rebar (Complete RCC Beam)</option>
      ...
      <div style={styles.stepperCard}>
        <div style={styles.sectionHeader}>
          <span>Ã°Å¸â€œÂ Beam Geometry & Structural Specifications</span>
        </div>

        <div style={styles.noteBox}>
          Ã°Å¸â€™Â¡ <strong>IS 456 Structural Beam Standards</strong>: Select whether to compute Concrete Materials, Steel Rebar, or Both. Includes nominal mix proportions, top & bottom bar anchorage lengths, stirrup 135Ã‚Â° hooks, 25mm clear cover, and beam soffit/side formwork shuttering.
        </div>
        ...
        {calcResults.hasSteel && (
          <div style={{ backgroundColor: '#fff5f7', padding: '14px', borderRadius: '8px', marginBottom: '16px', border: '1px solid #fecdd3' }}>
            <div style={{ fontSize: '13px', fontWeight: '700', color: '#800020', marginBottom: '10px' }}>Ã°Å¸â€â€ž Top & Bottom Longitudinal Reinforcement</div>
            <div style={styles.grid4}>
              <div style={styles.fieldGroup}>
        ...
        {calcResults.hasSteel && (
          <div style={{ backgroundColor: '#f0fdf4', padding: '14px', borderRadius: '8px', marginBottom: '16px', border: '1px solid #bbf7d0' }}>
            <div style={{ fontSize: '13px', fontWeight: '700', color: '#166534', marginBottom: '10px' }}>Ã°Å¸â€â€ž Shear Stirrups & Cover Controls</div>
        ...
        <div style={{ display: 'flex', justifyContent: 'flex-end', marginTop: '10px' }}>
          <button style={styles.btnReset} onClick={handleReset}>Ã°Å¸â€â€ž Reset Beam Form</button>
        </div>
      </div>
      ...
      <div style={styles.stepperCard}>
        <div style={styles.sectionHeader}>
          <span>Ã°Å¸â€œÅ  Beam Results BOQ ({scopeOption === 'both' ? 'Concrete & Steel' : scopeOption === 'concrete_only' ? 'Concrete & Formwork' : 'Steel Rebar Only'})</span>
        </div>
