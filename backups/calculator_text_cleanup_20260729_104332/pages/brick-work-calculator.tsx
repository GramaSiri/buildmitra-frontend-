  ...
  const handleShareWhatsApp = () => {
    checkAndRun('calculator_export', 'brick-work-calculator', () => {
      ...
      const msg = `*BuildMitra Block/Brick Work Calculator Report*%0A` +
        ...
        `----------------------------------------%0A` +
        `Ã¢â‚¬Â¢ *Net Wall Area*: ${formatNumber(res.netWallArea)} Sqft%0A` +
        `Ã¢â‚¬Â¢ *Masonry Volume*: ${formatNumber(res.masonryVolCft)} CFT%0A` +
        `Ã¢â‚¬Â¢ *Bricks / Blocks Quantity*: ${formatNumber(res.totalBlocks, 0)} Nos%0A` +
        `Ã¢â‚¬Â¢ *Cement (50kg OPC 53)*: ${formatNumber(res.cemBags)} Bags%0A` +
        `Ã¢â‚¬Â¢ *M-Sand*: ${formatNumber(res.sandCft)} CFT%0A` +
        `Ã¢â‚¬Â¢ *Site Water*: ${formatNumber(res.waterLtr)} Litres%0A` +
...
{/* 1. Header */}
      <div style={styles.header}>
        ...
        <h1 style={styles.headerTitle}>
          Ã°Å¸Â§Â± Block/Brick Work Calculator
      ...
      <div style={styles.dropdownCard}>
        ...
        >
          ...
          <option value="detailed">Ã°Å¸â€œÂ Detailed Wall-Wise Calculation (Exact Room Dimensions & Openings)</option>
        </select>
      </div>
        </div>
        ...
        <>
          <div style={styles.stepperCard}>
            <div style={styles.sectionHeader}>
              <span>Ã¢Å¡Â¡ Quick Calculation (Plot Dimensions & Wall Thickness BUA Rule)</span>
            </div>

            <div style={styles.noteBox}>
              Ã°Å¸â€™Â¡ <strong>IS Code Volumetric Rule</strong>: Block count, Cement Bags, Sand CFT, and Water Litres automatically scale with Wall Thickness (4.5", 6", 8", 9") and Mortar Joint Thickness.
            </div>
          ...
          <div style={styles.stepperCard}>
            <div style={styles.sectionHeader}>
              <span>Ã°Å¸â€œÅ  Block/Brick Work Calculation Results & Materials BOQ</span>
            </div>
      ...
      {calcMode === 'detailed' && (
        <div style={styles.stepperCard}>
          <div style={styles.sectionHeader}>
            <span>Ã°Å¸â€œÂ Detailed Wall-Wise Brickwork Calculation Inputs (IS 2212 Exact Rules)</span>
          </div>
          ...
          <div style={{ backgroundColor: '#f1f5f9', padding: '12px', borderRadius: '8px', marginBottom: '16px' }}>
            <div style={{ fontSize: '13px', fontWeight: '700', color: '#0f766e', marginBottom: '8px' }}>Ã°Å¸Å¡Âª Openings Deduction (Doors & Windows Volume Deduction)</div>
            <div style={styles.grid4}>
              <div style={styles.fieldGroup}>
          ...
          <div style={{ marginTop: '16px' }}>
            <div style={styles.sectionHeader}>
              <span>Ã°Å¸â€œÅ  Detailed Block/Brick Work Calculation Results & Materials BOQ</span>
            </div>
