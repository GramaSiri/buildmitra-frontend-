  ...
  const handleShareWhatsApp = () => {
    checkAndRun(() => {
      ...
      const msg = `*BuildMitra Paint Calculator Report*%0A` +
        ...
        `----------------------------------------%0A` +
        `Ã¢â‚¬Â¢ *Net Paint Area*: ${formatNumber(calcMode === 'quick' ? quickCalcResults.paintableArea : detailedCalcResults.totalPaintArea)} Sqft%0A` +
        `Ã¢â‚¬Â¢ *Material Cost*: ${formatCurrency(res.grandMatCost)}%0A` +
        `Ã¢â‚¬Â¢ *Labour Cost*: ${formatCurrency(res.grandLabCost)}%0A` +
        `Ã¢â‚¬Â¢ *TOTAL ESTIMATED COST*: ${formatCurrency(res.grandTotal)} (${formatCurrency(res.costPerSqft)}/Sqft)%0A%0A` +
...
{/* 1. Header */}
      ...
      <div style={styles.dropdownCard}>
        ...
        >
          <option value="quick">Ã¢Å¡Â¡ Quick Calculation (Estimate from Total Surface or Built-Up Area)</option>
          <option value="detailed">Ã°Å¸â€œÂ Detailed Wall-Wise Calculation (Exact Room & Opening Measurements)</option>
        </select>
      </div>
        </div>
        ...
        <>
          <div style={styles.stepperCard}>
            <div style={styles.sectionHeader}>
              <span>Ã¢Å¡Â¡ Quick Paint Calculation Inputs</span>
            </div>

            <div style={styles.noteBox}>
              Ã°Å¸â€™Â¡ <strong>IS 2395 Recommendations & Standards</strong>:
              <br />Ã¢â‚¬Â¢ <strong>External Painting</strong>: Exterior Weatherproof Primer + Exterior Weatherproof Emulsion.
              <br />Ã¢â‚¬Â¢ <strong>Internal Painting</strong>: Interior Putty (2 Coats ~0.10 kg/sqft) + Interior Primer + Acrylic / Royal Emulsion.
            </div>
          ...
          <div style={styles.stepperCard}>
            <div style={styles.sectionHeader}>
              <span>Ã°Å¸â€œÅ  Paint Calculation Results & Materials BOQ</span>
            </div>
      ...
      {calcMode === 'detailed' && (
        <div style={styles.stepperCard}>
          <div style={styles.sectionHeader}>
            <span>Ã°Å¸â€œÂ Detailed Wall-Wise Paint Calculation Inputs</span>
          </div>
          ...
          <div style={{ backgroundColor: '#f1f5f9', padding: '12px', borderRadius: '8px', marginBottom: '16px' }}>
            <div style={{ fontSize: '13px', fontWeight: '700', color: '#0f766e', marginBottom: '8px' }}>Ã°Å¸Å¡Âª Openings (Doors & Windows Deduction & Enamel Paint)</div>
            <div style={styles.grid4}>
              <div style={styles.fieldGroup}>
          ...
          <div style={{ backgroundColor: '#f1f5f9', padding: '12px', borderRadius: '8px', marginBottom: '16px' }}>
            <div style={{ fontSize: '13px', fontWeight: '700', color: '#0f766e', marginBottom: '8px' }}>Ã°Å¸Å½Â¨ Special / Texture Design Paints</div>
            <div style={styles.grid3}>
              <div style={styles.fieldGroup}>
          ...
          <div style={{ marginTop: '16px' }}>
            <div style={styles.sectionHeader}>
              <span>Ã°Å¸â€œÅ  Detailed Paint Calculation Results & Materials BOQ</span>
            </div>
