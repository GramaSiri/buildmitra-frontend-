...
const [projectName,setProjectName]=useState("Jai Sri ram"),[clientName,setClientName]=useState("Reddy"),[mobileNo,setMobileNo]=useState("7676942386"),[city,setCity]=useState("Bengaluru");
  ...
  return <div style={styles.container}>
    ...
    {generated&&results&&<div>
      ...
      <div style={styles.buttonContainer}><button onClick={() => checkAndRun('boq_export', 'boq-civil.before-professional', handleExportExcel)} style={styles.buttonExport}>📊 Export Excel</button><button onClick={() => checkAndRun('boq_export', 'boq-civil.before-professional', handleWhatsApp)} style={styles.buttonWhatsapp}>💬 WhatsApp Share</button></div>
