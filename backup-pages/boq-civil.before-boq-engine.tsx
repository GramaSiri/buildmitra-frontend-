...
const router = useRouter();
  ...
  return React.createElement('div', { style: styles.container },
    ...
    generated && results && React.createElement('div', null,
      ...
      React.createElement('div', { style: styles.buttonContainer },
        React.createElement('button', { onClick: () => checkAndRun('boq_export', 'boq-civil.before-boq-engine', handleExportExcel), style: styles.buttonExport }, '📊 Export Excel'),
        React.createElement('button', { onClick: () => checkAndRun('boq_export', 'boq-civil.before-boq-engine', handleWhatsApp), style: styles.buttonWhatsapp }, '💬 WhatsApp Share')
      ),
