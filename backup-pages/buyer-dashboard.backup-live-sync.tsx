...
const isReadOnly = false;
    ...
    React.createElement("div", { style: styles.card },
      ...
      React.createElement("div", { style: { display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(180px, 1fr))", gap: "16px" } },
        projectMedia.map((m: any) =>
          React.createElement("div", { key: m.id, style: { border: "1px solid #ddd", borderRadius: "8px", overflow: "hidden", cursor: "pointer" }, onClick: () => { if (m.url || m.previewUrl) { window.open(m.url || m.previewUrl, "_blank"); } else { setSelectedMedia(m); setShowMediaViewer(true); } } },
  ...
  return React.createElement("div", { style: styles.container },
    React.createElement("div", { style: styles.header },
      ...
      React.createElement("div", null,
        React.createElement("button", { onClick: () => checkAndRun('calculator_export', 'buyer-dashboard.backup-live-sync', shareWhatsApp), style: styles.buttonSuccess }, "📱 Share Update"),
