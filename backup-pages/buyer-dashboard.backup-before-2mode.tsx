...
const isReadOnly = false;
  ...
  return React.createElement("div", { style: styles.container },
    React.createElement("div", { style: styles.header },
      ...
      React.createElement("div", null,
        React.createElement("button", { onClick: () => checkAndRun('calculator_export', 'buyer-dashboard.backup-before-2mode', shareWhatsApp), style: styles.buttonSuccess }, "📱 Share Update"),
